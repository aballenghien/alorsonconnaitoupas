...
@Api(name = "scoreendpoint", namespace = @ApiNamespace(ownerDomain = "mycompany.com", ownerName = "mycompany.com", packagePath = "services"))
public class ScoreEndpoint {
	...
	public Score getScore(@Named("id") Long id) {
		PersistenceManager mgr = getPersistenceManager();
		Score score = null;
		try {
			score = mgr.getObjectById(Score.class, id);
		} finally {
			mgr.close();
		}
		return score;
	...
	public void removeScore(@Named("id") Long id) {
		PersistenceManager mgr = getPersistenceManager();
		try {
			Score score = mgr.getObjectById(Score.class, id);
	...
	private boolean containsScore(Score score) {
		PersistenceManager mgr = getPersistenceManager();
		boolean contains = true;
		try {
			mgr.getObjectById(Score.class, score.getId());
